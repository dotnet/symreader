...
The implementation of these interfaces for Windows PDBs is provided by `Microsoft.DiaSymReader.Native.{platform}.dll`, which ships in the .NET runtime. The implementation for Portable PDBs is provided by [Microsoft.DiaSymReader.PortablePdb](https://www.nuget.org/packages/Microsoft.DiaSymReader.PortablePdb) package. 
