...
{
    // TODO: consider returning "int" from DefineDocument to avoid generic type.

    /// <summary>
    /// Abstract Windows PDB writer.
    /// </summary>
    /// <typeparam name="TDocumentWriter">The type that represents PDB document.</typeparam>
